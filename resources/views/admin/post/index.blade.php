        ...
        <table class="table table-hover text-nowrap text-center">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>
                  <a href="{{ route('admin#posteditpage',$post->id)}}"><button class="btn btn-sm bg-dark text-white"><i class="fas fa-edit"></i></button>
                  </a>
                  <a href="{{ route('admin#postdelete',$post->id)}}"><button class="btn btn-sm bg-danger text-white"><i class="fas fa-trash-alt"></i></button>
                  </a>
                </td>
              </tr>
            @endforeach
